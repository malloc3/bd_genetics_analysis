...
%================================================================================================
    ...
    \section{What I have done (in rough order with dates)}
        ...
        \item \textbf{bwa_mem:} (04/01/26) Re running bwa-mem on Imani Trimmo Samples.   THis is beccause I can't find the original samples and want to make sure I have good alignments.   Doing it in a single run even though it is slower.   Will make the files a little easier to track in the end i think.
        
        \item \textbf{bowtie:} 04/01/26 Re_running the bowtie alignment of Imani Trimmo Samples.   This is because I can't find the original samples and want to make sure I have good alignments.  Doing it in a single run even through it is slower.   Will make the files a little easier to track and in the end I think this will help.
