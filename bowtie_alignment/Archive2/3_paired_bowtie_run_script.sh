...
reference_genome="$SLURM_SUBMIT_DIR""/fast_q_files/Reference_genomes/ASM359527v1/ncbi_dataset/data/GCA_036783925.1/GCA_036783925.1_UCR_BdCLFT044_1.0_genomic.fna"

#this is the name of the index files that will be created for this reference genome
reference_genome_name="GCA_036783925.1_UCR_BdCLFT044_1.0_genomic"
...
#Only build the index if the index hasn't already been built.   There isn't error checking for this in this script.
# The error checking is done in the bowtie script
if $build_index; then
